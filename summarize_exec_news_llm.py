...
- 임원인사 예(재선임·직무 필수): 기사 '이성주 서울대 교수와 정환 고려대 교수가 감사위원으로 재선임' → **잘못**: '이성주'의 재선임 / **올바름**: '이성주' 서울대 산업공학과 교수의 감사위원 재선임, '정환' 고려대 통계학과 교수의 감사위원 재선임. 기사 '현신균 대표는 연임에 성공' → '현신균' 대표이사 연임(또는 재선임)처럼 **대표 직함**을 previous_role·personnel_type에 반영.
