...
- **임원인사**: '내정'(예정)·'선임'/'임명'(확정)·'주총 안건'/'승인 대기'(통과 여부가 안건)를 구분. personnel_type에 단계를 넣고(예: 사내이사 신규 선임 안건, 부회장 내정, 대표이사 선임). 실행 시기(주총 승인 후, 2026년 3월부터 등)가 언급되면 **personnel_timing에만** 넣고(예: "주총 승인 후", "2026년 3월부터"). 문장 끝에 괄호로 "(주총 승인 후)" 적지 말 것—시기는 메일에서 문장 앞에 "주총 승인 후, " 형태로 표시됨.
